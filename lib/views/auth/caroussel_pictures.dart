                                    ...
                                    child: GestureDetector(
                                      onTap: () => navAuthKey.currentState!
                                          .pushNamed(userProfile,
                                              arguments: [ref.read(userNotifierProvider), false]),
                                      child: ref
                                ...
                                Column(
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Text(
                                          ref.read(userNotifierProvider).pseudo,
...
//   const CarousselPictures({Key? key, required this.message, required this.user})
//       : super(key: key);
...
//                                 ),
//                                 Text(
//                                     "${Helpers.formatDateDayWeek(int.parse(widget.message.timestamp), ref.read(localeLanguageNotifierProvider).languageCode)} à ${Helpers.formatDateHoursMinutes(int.parse(widget.message.timestamp), ref.read(localeLanguageNotifierProvider).languageCode)}",
//                                     style: textStyleCustomBold(cGrey, 14),
//                                     textScaleFactor: 1.0)
//                               ],
//                             )
